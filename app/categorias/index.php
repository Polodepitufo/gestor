													...
													?>
														<tr>
															...
															<form class="form" novalidate="novalidate" id="formulario_eliminar" method="POST">
																<div class="d-flex align-items-center gap-2 gap-lg-3">
																	<button type="button" class="btn btn-sm fw-bold btn-danger boton-eliminar" data-kt-ecommerce-category-filter="delete_row" name="boton-eliminar">X</button>
																	<input hidden name="eliminar_categoria" value="<?php echo $id_categoria; ?>">
																</div>
																</form>
															</td>
														</tr>
